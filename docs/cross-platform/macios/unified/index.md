...
- [기존 iOS 앱을 업데이트 합니다.](updating-ios-apps.md)
- [기존 Mac 응용 프로그램 업데이트](updating-mac-apps.md)
- [Xamarin.Forms는 기존 앱을 업데이트 합니다.](updating-xamarin-forms-apps.md)
- [바인딩이 통합된 API로 마이그레이션](update-binding.md)

## <a name="tips-for-updating-code-to-the-unified-apiupdating-tipsmd"></a>[통합 된 API에 코드를 업데이트 하기 위한 팁](updating-tips.md)
...
지원 32와 64 비트 응용 프로그램 및 프레임 워크에 대 한 정보에 대 한 배경에 대 한 참조는 [32, 64 비트 플랫폼 고려 사항](~/cross-platform/macios/32-and-64.md)합니다.
