...
각 플랫폼에서 사용할 수 있는 시각적 화면 디자이너를 표시 하는 이러한 스크린샷:
 ...
 [ ![](part-1-understanding-the-xamarin-mobile-platform-images/designer-all1.png "이러한 스크린샷 각 플랫폼에서 사용할 수 있는 시각적 화면 디자이너를 보여 줍니다.")](part-1-understanding-the-xamarin-mobile-platform-images/designer-all1.png)
