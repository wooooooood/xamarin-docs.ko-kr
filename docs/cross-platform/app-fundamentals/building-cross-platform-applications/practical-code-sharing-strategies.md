...
ServiceStack 웹 사이트에는 [xamarin.ios 예제](http://www.servicestack.net/monotouch/remote-info/) 와 [웹 서비스 설명서](~/cross-platform/data-cloud/web-services/index.md)의 코드 조각이 있습니다.
