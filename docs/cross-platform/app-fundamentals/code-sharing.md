...
코드 파일을 공유 하는 가장 간단한 방법은 (Xamarin Studio 5 및 Visual Studio 2013 업데이트 2에서 도입) 공유 프로젝트를 사용 하는 것입니다. 공유 프로젝트는 [여기에서 자세히 설명한](~/cross-platform/app-fundamentals/shared-projects.md)합니다.
...
- [Visual Studio 2013에 대 한 프로젝트 참조 관리자를 공유합니다.](http://visualstudiogallery.msdn.microsoft.com/315c13a7-2787-4f57-bdf7-adae6ed54450)
