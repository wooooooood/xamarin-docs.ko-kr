...
이 섹션에서는 Razor 템플릿을 사용 하 여 간단한 읽기 전용 뷰를 렌더링 하는 기본적인 방법을 설명 했습니다. 다음 섹션에는 사용자 입력을 허용 하 고 HTML 보기와 C#에서 Javascript 상호 운용할 수 있는 Razor를 사용 하 여 전체 앱을 빌드하는 방법을 설명 합니다.
