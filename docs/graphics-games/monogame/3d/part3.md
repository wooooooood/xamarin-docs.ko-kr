...
이 일반 곱하기와 약간 다를 작동 하는 매트릭스 곱 라고 합니다. *곱하기의 가환 적 속성이* 상태 곱하기 연산에서 숫자의 순서는 결과 변경 되지 않습니다. 즉, 3 * 4는 4 * 3 에 해당 합니다. 행렬 곱 달리 하은 누적 되지 않습니다. 즉, "적용 하 여 모델 translationMatrix 한 다음 모든 항목은 rotationMatrix 적용 하 여 회전" 위의 줄으로 읽을 수 있습니다. 위의 줄 영향을 받는 있다는 위치 및 회전 다음과 같이 하는 방법을 시각적으로 나타낼 수 있습니다.
