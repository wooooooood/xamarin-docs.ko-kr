...
![](part1-images/image1.png "완료 되 면 프로젝트 다음과 같이 표시 됩니다.")
...
![](part1-images/image2.png "한 번 배포 개발자는 빈 파란색 스크린 나타나야 합니다.")
...
![](part1-images/xnbsinxs.png "두 파일은 프로젝트의 일부를 지금 여야 합니다.")
...
![](part1-images/image8.png "이 코드를 실행 하는 경우 모델 화면 표시 됩니다.")

위의 코드의 더 중요 한 부분 중 일부에 대해 살펴보겠습니다.
...
![](part1-images/image9.png "해당 개의 질감 같지만 없는 음영 또는 반사 광선을 렌더링 하는 모델")
...
![](part1-images/image10.png "이 코드 3 전체 단위에 의해 이동 된 개체에서 발생")
...
![](part1-images/image11.png "카메라에 더 이상 이동할 다시 관점으로 인해 더 작은 표시 되는 모델의 결과")
...
![](part1-images/image1.png "이 인해 로봇 6 번 그리고 모델")
