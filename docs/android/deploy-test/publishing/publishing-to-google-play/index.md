...
이 섹션에서는 게시자가 되기 위한 등록, Google Play의 응용 프로그램 판촉 및 광고를 위한 자산 수집, Google Play 응용 프로그램 등급 지침, 필터를 사용하여 특정 디바이스에 대한 응용 프로그램 배포 제한 등과 같은 Google Play 특정 항목을 다룹니다.
