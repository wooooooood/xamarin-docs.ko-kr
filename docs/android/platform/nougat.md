...
[![Android 태블릿 및 휴대폰 Android Nougat 실행의 이미지 Hero](nougat-images/android-n-hero-sml.png)](nougat-images/android-n-hero.png#lightbox)
...
> [!NOTE]
> 현재 설정 해야 합니다는 **최소 Android 버전** 를 **Android 7.0 (API 24-Nougat)** Nougat Android 장치 또는 에뮬레이터에 앱을 배포 하려면.
...
[![AVD Nexus 6 장치, Android 7.0 대상 및 Intel x86 Atom CPU/ABI를 사용 하 여 구성](nougat-images/android-n-avd.png)](nougat-images/android-n-avd.png#lightbox)
...
[![인라인 직접 회신 필드와 알림 스크린 샷](nougat-images/notifications-inline-reply-sml.png)](nougat-images/notifications-inline-reply.png#lightbox)
...
[![번들로 묶은 알림 스크린 샷 예제](nougat-images/bundled-notifications-sml.png)](nougat-images/bundled-notifications.png#lightbox)
...
[![앱 바로 가기 메뉴를 사용 하 여 메시징 응용 프로그램에의 예제에서는 화면](nougat-images/app-shortcuts-sml.png)](nougat-images/app-shortcuts.png#lightbox)
