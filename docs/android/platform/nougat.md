...
Xamarin Android 앱의 작업에서 다중 창 모드를 지 원하는 방법을 구성할 수 있습니다. 예를 들어, 앱의 최소 크기와 기본 높이 및 너비를 여러 창 모드로 설정 하는 특성을 구성할 수 있습니다. 새 `Activity.IsInMultiWindowMode` 속성을 사용 하 여 활동이 다중 창 모드 인지 여부를 확인할 수 있습니다. 예:
