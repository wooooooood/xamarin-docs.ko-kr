...
> [!NOTE]
> 기본 Android 장치가 TLS 1.2 (즉를 지원 해야 합니다. Android 4.1 이상)입니다. 하세요 Android 5.0 이상에서 TLS 1.2에 대 한 공식 지원은 됩니다. 그러나 일부 장치는 Android 4.1 이상에서 TLS 1.2를 지원 합니다.
