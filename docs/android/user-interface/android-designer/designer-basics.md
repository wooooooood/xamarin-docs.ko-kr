...
- **Design Surface** &ndash;는 레이아웃을 장치에 표시 하는 방법에 대 한 편집 가능한 표현을 제공 하 여 사용자 인터페이스의 시각적 생성을 용이 하 게 합니다. **Design Surface** **디자인 창** 안에 표시 됩니다 (위에 있는 **디자이너 도구 모음** 포함).

- **원본 창** &ndash; **Design Surface**에 제공 된 디자인에 해당 하는 기본 XML 원본에 대 한 뷰를 제공 합니다.

- **디자이너 도구 모음** &ndash; **장치**, **버전**, **테마**, 레이아웃 구성 및 작업 모음 설정 등의 선택기 목록을 표시 합니다. **디자이너 도구 모음** 에는 테마 편집기를 시작 하 고 재질 디자인 그리드를 사용 하기 위한 아이콘도 포함 되어 있습니다.

- **도구 상자** &ndash; **Design Surface**에 끌어서 놓을 수 있는 위젯 및 레이아웃 목록을 제공 합니다.
...
- 다른 레이아웃 버전에서 선택할 수 &ndash; **대체 레이아웃 선택기** 입니다.

- **장치 선택기** &ndash; 특정 장치와 연결 된 일련의 한정자 (예: 화면 크기, 해상도 및 키보드 가용성)를 정의 합니다. 새 장치를 추가 하 고 삭제할 수도 있습니다.

- **Android 버전 선택기** 는 레이아웃을 대상으로 하는 android 버전을 &ndash; 합니다. 디자이너에서 선택한 Android 버전에 따라 레이아웃이 렌더링 됩니다.

- **테마 선택기** &ndash; 레이아웃에 대 한 UI 테마를 선택 합니다.

- **구성 선택기** &ndash; *세로* 또는 *가로*와 같은 장치 구성을 선택 합니다.

- **리소스 한정자 옵션** &ndash; *언어*, *UI 모드*, *야간 모드*및 *둥근 화면* 옵션을 선택 하는 드롭다운 메뉴를 표시 하는 대화 상자를 엽니다.

- **작업 모음 설정** &ndash; 레이아웃에 대 한 작업 모음 설정을 구성 합니다.

- 테마 **편집기** &ndash; *테마 편집기*를 엽니다 .이 편집기를 사용 하면 선택한 테마의 요소를 사용자 지정할 수 있습니다.

- **재질 디자인 모눈** &ndash; *재질 디자인 그리드*를 사용 하거나 사용 하지 않도록 설정 합니다. 재질 디자인 그리드 옆에 있는 드롭다운 메뉴 항목은 표를 사용자 지정할 수 있는 대화 상자를 엽니다.
...
- **LinearLayout** &ndash; `TextView`의 `LinearLayout` 부모를 편집 하는 하위 메뉴를 엽니다.

- 마우스 오른쪽 단추로 클릭 한 `TextView`에 적용 되는 &ndash; 작업을 **삭제**, **복사**및 **잘라냅니다** .
...
- **컨테이너 &ndash; 강조 표시** 하 여 **Design Surface** 의 컨테이너를 강조 표시 하 여 확대/축소 하는 동안 쉽게 찾을 수 있도록 합니다.

- **보통 크기** &ndash; 레이아웃 픽셀의 레이아웃 픽셀을 렌더링 하므로 레이아웃의 해상도가 선택한 장치의 해상도에서 어떻게 표시 되는지 확인할 수 있습니다.

- **창에 맞추기** &ndash; 전체 레이아웃이 Design Surface에 표시 되도록 확대/축소 수준을 설정 합니다.

- **확대** &ndash; 각 클릭에 맞게 증분 하 여 레이아웃을 확대 합니다.

- **축소** &ndash; 각 클릭에 따라 증분 방식으로 축소 하 여 Design Surface에서 레이아웃을 더 작게 표시 합니다.
...
- **디자인 &ndash; 디자인** **창에서 디자인을 선택** **합니다.** 이 단추를 클릭 하면 **도구 상자** 및 **속성** 창이 활성화 되 고 **텍스트 편집기 도구 모음이** 표시 되지 않습니다. **축소** 단추를 클릭 하면 (아래 참조) **소스** 창이 없으면 **디자인** 창이 단독으로 표시 됩니다.

- **창 바꾸기** 는 두 개의 반대 방향 화살표와 비슷한이 단추를 &ndash; **소스** 창이 왼쪽에 있고 **디자인** 창이 오른쪽에 오도록 **디자인** 창과 **소스** 창을 바꿉니다. 다시 클릭 하면 이러한 창이 원래 위치로 다시 바뀝니다.

- **원본** &ndash;이 단추 (두 개의 반대 꺾쇠 괄호와 비슷함)는 **원본** 창을 선택 합니다. 이 단추를 클릭 하면 **도구 상자** 및 **속성** 창이 사용 하지 않도록 설정 되 고 **텍스트 편집기 도구 모음이** Visual Studio 위쪽에 표시 됩니다. **축소** 단추를 클릭할 때 (아래 참조) **원본** 단추를 클릭 하면 **디자인** 창 대신 **소스** 창이 표시 됩니다.

- **세로 분할** 이 단추 (세로 막대와 비슷함) &ndash; **디자인** 창과 **소스** 창이 나란히 표시 됩니다. 이는 기본 정렬입니다.

- **가로 분할** 이 단추 &ndash; 가로 막대와 비슷하며 **소스** 창 위에 **디자인** 창이 표시 됩니다. 창 **바꾸기** 를 클릭 하면 **디자인** 창 위에 **소스** 창이 추가 됩니다.

- **축소 창** &ndash;이 단추 (오른쪽 꺾쇠 괄호 두 개)가 **디자인** 및 **원본의** 이중 창 표시를 이러한 창 중 하나의 단일 뷰로 "축소" 합니다.
...
일부 속성은 레이아웃 **. axml** 파일 이외의 파일에 정의 된 리소스를 참조할 수 있습니다. 이 형식의 가장 일반적인 경우는 `string` 및 `drawable` 리소스입니다. 그러나 `Boolean` 값 및 차원과 같은 다른 리소스에도 참조를 사용할 수 있습니다. 속성이 리소스 참조를 지 원하는 경우 속성에 대 한 텍스트 항목 옆에 찾아보기 아이콘 (사각형)이 표시 됩니다. 이 단추를 클릭 하면 리소스 선택 기가 열립니다.
...
*부울* 속성은 일반적으로 속성 창의 속성 옆에 있는 확인 표시로 선택 됩니다. 이 확인란을 선택 하거나 선택 취소 하 여 `true` 또는 `false` 값을 지정 하거나, 속성의 오른쪽에 있는 짙은 채워진 사각형을 클릭 하 여 속성 참조를 선택할 수 있습니다. 다음 예제에서는 선택 된 `TextView`와 연결 된 **모든 문자 텍스트 대문자로** 된 부울 속성 참조를 클릭 하 여 텍스트를 모두 대문자로 변경 합니다.
...
<kbd>enter</kbd> 키를 눌러 입력 한 텍스트를 새 리소스에 자동으로 연결할 수 있습니다.
...
- **Design Surface** &ndash;는 레이아웃을 장치에 표시 하는 방법에 대 한 편집 가능한 표현을 제공 하 여 사용자 인터페이스의 시각적 생성을 용이 하 게 합니다.

- **도구 모음** &ndash; **장치**, **버전**, **테마**, 레이아웃 구성 및 작업 모음 설정 등의 선택기 목록을 표시 합니다. 도구 모음에는 테마 편집기를 시작 하 고 재질 디자인 그리드를 사용 하기 위한 아이콘도 포함 되어 있습니다.

- **도구 상자** &ndash; Design Surface에 끌어서 놓을 수 있는 위젯 및 레이아웃 목록을 제공 합니다.
...
- **장치 선택기** &ndash;는 화면 크기, 해상도, 키보드 가용성 등의 특정 장치와 연결 된 한정자 집합을 정의 합니다. 새 장치를 추가 하 고 삭제할 수도 있습니다.
...
- **LinearLayout** &ndash; `Button`의 `LinearLayout` 부모를 편집 하는 하위 메뉴를 엽니다.

- 마우스 오른쪽 단추로 클릭 한 `Button`에 적용 되는 &ndash; 작업을 **잘라내거나** **복사**하 고 **삭제** 합니다.
...
- **컨테이너 &ndash; 강조 표시** 하 여 Design Surface의 컨테이너를 강조 표시 하 여 확대/축소 하는 동안 쉽게 찾을 수 있도록 합니다.
...
속성 패드는 유사한 &ndash; 속성을 그룹화 하는 여러 섹션으로 나뉘어 있으므로 관심 있는 속성을 보다 쉽게 찾을 수 있습니다.
...
일부 속성은 레이아웃 **. axml** 파일 이외의 파일에 정의 된 리소스를 참조할 수 있습니다. 이 형식의 가장 일반적인 경우는 `string` 및 `drawable` 리소스입니다. 그러나 `Boolean` 값 및 차원과 같은 다른 리소스에도 참조를 사용할 수 있습니다.
속성이 리소스 참조를 지 원하는 경우 속성에 대 한 텍스트 항목 옆에 찾아보기 아이콘 (줄임표, &hellip;)이 표시 됩니다.
