...
1. 다음 목록 (각 링크 URL의 해당 MD5 해시와 함께) &ndash; 링크를 제공 하는 오류 메시지에 해당 하는 **android\_m2repository\_r_nn_ .zip** 파일을 다운로드 합니다.
    ...
    **M2repository** archive가이 테이블에 표시 되지 않으면 다운로드할 **m2repository** 이름 앞에 `https://dl-ssl.google.com/android/repository/`를 추가할 수 있습니다. 예를 들어 **https://dl-ssl.google.com/android/repository/android\_m2repository\_r10.zip** 를 사용 하 여 **android\_m2repository\_r10**를 다운로드 합니다.
