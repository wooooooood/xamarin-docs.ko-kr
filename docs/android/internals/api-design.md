...
- [\<](https://developer.android.com/reference/java/util/Set.html) [JavaSetT>시스템형식ICollectiont>에매핑되는>집합E.\<](xref:Android.Runtime.JavaSet`1) [\<](xref:System.Collections.Generic.ICollection`1)

- [JavaList\<](https://developer.android.com/reference/java/util/List.html) [E >은 시스템 형식 IList\<t >](xref:System.Collections.Generic.IList`1), 도우미 클래스 >에 매핑됩니다. [\<](xref:Android.Runtime.JavaList`1)
...
- [JavaCollection\<](https://developer.android.com/reference/java/util/Collection.html) [E >은 시스템 형식 ICollection\<t >](xref:System.Collections.Generic.ICollection`1), 도우미 클래스 >에 매핑됩니다. [\<](xref:Android.Runtime.JavaCollection`1)
