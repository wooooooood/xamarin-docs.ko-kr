...
##  <a name="walkthrough---using-local-notifications-in-xamarinioslocal-notifications-in-ios-walkthroughmd"></a>[연습-Xamarin.iOS에 로컬 알림을 사용 하 여](local-notifications-in-ios-walkthrough.md)
