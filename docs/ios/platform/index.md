...
IOS 7에서에서 운영 체제에 많은 수의 변경 내용 적용 하는 Apple iOS 8. 여기에서 정의 및 사용 하는 방법을 보여줍니다.
...
소셜 프레임 워크는 통합된 API를 포함 한 소셜 네트워크와 상호 작용 하기 위한 제공 _Twitter_ 및 _Facebook_,으로 _SinaWeibo_ 중국에서 사용자에 대 한 합니다.
