...
사각형 검색은 종종 작업 체인에서 첫 번째 단계입니다. [예를 들어](~/ios/platform/introduction-to-ios11/coreml.md#coremlvision)사각형이 coreml 모델에 전달 되어 필기 숫자를 구문 분석 합니다.
