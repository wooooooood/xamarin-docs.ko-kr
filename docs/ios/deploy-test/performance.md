...
description: "Xamarin.iOS로 빌드된 응용 프로그램의 성능을 높이기 위한 많은 기술이 있습니다. 이러한 기술은 전체적으로 CPU에서 수행하는 작업의 양과 응용 프로그램에서 소비하는 메모리의 양을 크게 줄일 수 있습니다. 이 문서에서는 이러한 기술에 대해 설명합니다."
ms.topic: article
ms.prod: xamarin
...
_Xamarin.iOS로 빌드된 응용 프로그램의 성능을 높이기 위한 많은 기술이 있습니다. 이러한 기술은 전체적으로 CPU에서 수행하는 작업의 양과 응용 프로그램에서 소비하는 메모리의 양을 크게 줄일 수 있습니다. 이 문서에서는 이러한 기술에 대해 설명합니다._
...
Xamarin.iOS로 빌드된 응용 프로그램의 성능과 인식 성능을 높이는 여러 가지 기술이 있습니다. 다음과 같은 변경 내용이 해당됩니다.

- [강력한 참조 순환 방지](#avoidcircularreferences)
- [테이블 뷰 최적화](#optimizetableviews)
- [불투명 뷰 사용](#opaqueviews)
- [FAT XIB 방지](#avoidfatxibs)
- [이미지 리소스 최적화](#optimizeimages)
- [장치에서 테스트](#testondevices)
- [디스플레이 새로 고침과 애니메이션 동기화](#synchronizeanimations)
- [코어 애니메이션 투명도 방지](#avoidtransparency)
- [코드 생성 방지](#avoidcodegeneration)
...
순환을 방지하는 한 가지 방법은 자식에서 부모로의 약한 참조를 사용하는 것입니다. 예를 들어 위의 코드는 다음과 같이 작성할 수 있습니다.
...
## <a name="optimize-table-views"></a>테이블 뷰 최적화
...
## <a name="use-opaque-views"></a>불투명 뷰 사용
...
## <a name="test-on-devices"></a>장치에서 테스트
