...
> [!IMPORTANT]
> Ctrl + 클릭으로 매핑되어 VMWare Windows 가상 컴퓨터에 대 한 사용 중인 경우는 _마우스 오른쪽 단추로 클릭_ 기본적으로 마우스 단추입니다. 편집을 통해 키보드 기본 설정에는 Segue를 만들려면 **기본 설정** > **키보드 및 마우스** > **마우스 바로 가기** 다시 매핑 및 사용자 **보조 단추** 아래 그림과 같이:
> 
