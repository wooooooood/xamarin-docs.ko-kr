...
#### [연습: 사용자 지정 컨트롤을 사용 하 여 ios 디자이너](user-interface/designer/ios-designable-controls-walkthrough.md)
...
#### [연습: 사용자 인터페이스를 만드는 JSON 사용](user-interface/monotouch.dialog/json-element-walkthrough.md)
...
#### [연습: 바인딩 iOS Objective C 라이브러리](platform/binding-objective-c/walkthrough.md)
...
#### [키트 개요 및 제품 정보를 검색 저장](platform/in-app-purchasing/store-kit-overview-and-retreiving-product-information.md)
...
##### [연습: 로컬 알림 Xamarin.iOS에서 사용 하 여](platform/user-notifications/deprecated/local-notifications-in-ios-walkthrough.md)
