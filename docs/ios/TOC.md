...
#### [개발용 디바이스 설정](get-started/installation/device-provisioning/index.md)
##### [자동 프로비저닝](get-started/installation/device-provisioning/automatic-provisioning.md)
##### [수동 프로비전](get-started/installation/device-provisioning/manual-provisioning.md)
...
#### [Objective-C 개발자용 C# 입문서](get-started/objective-c-developers/primer.md)
...
#### [애플리케이션 수명 주기 데모](app-fundamentals/backgrounding/application-lifecycle-demo.md)
...
##### [백그라운드에서 애플리케이션 업데이트](app-fundamentals/backgrounding/ios-backgrounding-techniques/updating-an-application-in-the-background.md)
...
#### [애플리케이션 아이콘](app-fundamentals/images-icons/app-icons.md)
...
### [iOS 디자이너](user-interface/designer/index.md)
#### [iOS 디자이너 기본 사항](user-interface/designer/introduction.md)
#### [iOS 디자이너의 사용자 지정 컨트롤](user-interface/designer/ios-designable-controls-overview.md)
#### [연습: iOS 디자이너에서 사용자 지정 컨트롤 사용](user-interface/designer/ios-designable-controls-walkthrough.md)
#### [iOS 디자이너를 통한 자동 레이아웃](user-interface/designer/designer-auto-layout.md)
...
#### [맵](user-interface/controls/ios-maps/index.md)
...
##### [행 작업 사용](user-interface/controls/tables/row-action.md)
...
#### [연습: 요소 API를 사용하여 애플리케이션 만들기](user-interface/monotouch.dialog/elements-api-walkthrough.md)
...
#### [연습: 리플렉션 API를 사용하여 애플리케이션 만들기](user-interface/monotouch.dialog/reflection-api-walkthrough.md)
...
##### [아키텍처 변경](platform/introduction-to-ios11/updating-your-app/architecture-changes.md)
##### [시각적 개체 디자인 업데이트](platform/introduction-to-ios11/updating-your-app/visual-design.md)
...
#### [비전](platform/introduction-to-ios11/vision.md)
...
#### [iOS 9 프레임워크 추가 변경 내용](platform/introduction-to-ios9/additional-framework-changes.md)
...
### [파일 압축](platform/file-compression.md)
...
### [색 변환기](~/essentials/color-converters.md?context=xamarin/ios)
### [나침반](~/essentials/compass.md?context=xamarin/ios)
### [연결](~/essentials/connectivity.md?context=xamarin/ios)
### [흔들림 탐지](~/essentials/detect-shake.md?context=xamarin/ios)
### [디바이스 표시 정보](~/essentials/device-display.md?context=xamarin/ios)
### [디바이스 정보](~/essentials/device-information.md?context=xamarin/ios)
### [전자 메일](~/essentials/email.md?context=xamarin/ios)
...
### [플랫폼 확장(크기, 직사각형, 점)](~/essentials/platform-extensions.md?context=xamarin/ios)
### [기본 설정](~/essentials/preferences.md?context=xamarin/ios)
### [보안 스토리지](~/essentials/secure-storage.md?context=xamarin/ios)
...
### [단위 변환기](~/essentials/unit-converters.md?context=xamarin/ios)
...
## [데이터 및 Cloud Services](data-cloud/index.md)
...
#### [앱 스토어 배포](deploy-test/app-distribution/app-store-distribution/index.md)
...
### [코드 서명 및 프로비전](deploy-test/provisioning/index.md)
#### [기능 사용](deploy-test/provisioning/capabilities/index.md)
...
##### [일치](deploy-test/provisioning/fastlane/match.md)
### [다른 디바이스용으로 컴파일](deploy-test/compiling-for-different-devices.md)
...
### [계측을 사용하여 Xamarin.iOS 애플리케이션 프로파일링](deploy-test/using-instruments-to-detect-native-leaks-using-markheap.md)
...
#### [바인딩 형식 참조](~/cross-platform/macios/binding/binding-types-reference.md?context=xamarin/ios)
#### [Objective Sharpie](~/cross-platform/macios/binding/objective-sharpie/index.md?context=xamarin/ios)
##### [시작](~/cross-platform/macios/binding/objective-sharpie/get-started.md?context=xamarin/ios)
...
#### [다음 메시지가 표시되며 내 앱 제출이 실패한 이유는 무엇인가요? "...에서 허용되지 않는 경로("iTunesMetadata.plist")를 발견했습니다."](troubleshooting/questions/itunesmetadata-disallowed-paths.md)
#### [RegisterServicePort에 발생하는 iOS 디자이너 오류](troubleshooting/questions/error-registerserviceport.md)
#### [키 집합에 유효한 iPhone 코드 서명 키가 없다는 오류와 함께 iOS 빌드에 실패하는 이유는 무엇인가요?](troubleshooting/questions/no-codesigning-keys.md)
#### [다음 메시지가 표시되며 내 iOS 9 앱이 실패한 이유는 무엇인가요? System.Exception: Objective-C 개체를 마샬링하지 못했습니다.](troubleshooting/questions/exception-marshal-obj-c.md)
...
#### [MDocArchiveToMsxDocConverter.exe에서 rver.BaseCommand.OnRequest를 찾을 수 없습니다.](troubleshooting/questions/mdocarchivetomsxdocconverter-not-found.md)
...
### [애플리케이션 기본 사항](watchos/app-fundamentals/index.md)
...
#### [이미지](watchos/user-interface/image.md)
#### [표](watchos/user-interface/table.md)
...
#### [운동 앱 고급 기능](watchos/platform/workout-apps.md)
...
#### [Hello, tvOS 빠른 시작 가이드](tvos/get-started/hello-tvos.md)
### [애플리케이션 기본 사항](tvos/app-fundamentals/index.md)
#### [아이콘 및 이미지 작업](tvos/app-fundamentals/icons-images.md)
#### [탐색 및 포커스 작업](tvos/app-fundamentals/navigation-focus.md)
#### [리소스 및 데이터 스토리지](tvos/app-fundamentals/resources-data-storage.md)
...
## [릴리스 정보](https://docs.microsoft.com/xamarin/ios/release-notes/)
