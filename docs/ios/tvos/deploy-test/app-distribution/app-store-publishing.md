...
Apple TV 앱 스토어에 포함 하기 위해 Apple에서 tvOS 앱을 수락 하려면 해당 앱이 실행 되는 모든 Apple TV 장치에 대 한 적절 한 아이콘, 시작 및 인기 이미지가 필요 합니다. ITunes Connect에 업로드 되기 전에 `Assets.car` 파일에 컴파일되고 tvOS 앱의 번들에 포함 되는 필수 이미지 자산을 추가 해야 합니다.
...
1. Mac용 Visual Studio에서 **릴리스 | 디바이스** 구성을 선택합니다:
    ...
    ![](app-store-publishing-images/buildxs01new.png "릴리스 구성 선택")
...
1. 아래 그림과 같이 **서명 및 배포 ...** 를 선택 합니다.
    ...
    [![](app-store-publishing-images/buildxs04new.png "TheSign 및 배포 ...를 선택 합니다.")](app-store-publishing-images/buildxs04new.png#lightbox)
...
3. 프로 비전 프로필 화면에서 서명 id 및 해당 프로 비전 프로필을 선택 하거나 다른 id로 다시 서명 합니다.
    ...
    [![](app-store-publishing-images/distribute02.png "서명 id 및 해당 프로 비전 프로필을 선택 합니다.")](app-store-publishing-images/distribute02.png#lightbox)
4. 패키지 세부 정보를 확인하고 **게시**를 클릭하여 `.ipa` 패키지를 저장합니다.

    [![](app-store-publishing-images/distribute03.png "패키지 세부 정보 확인")](app-store-publishing-images/distribute03.png#lightbox)
5. `.ipa`가 저장되면 앱이 응용 프로그램 로더를 통해 iTunes Connect에 업로드될 준비가 됩니다.

    [![](app-store-publishing-images/distribute04.png "응용 프로그램 로더를 통해 iTunes Connect에 업로드 됨")](app-store-publishing-images/distribute04.png#lightbox)
...
4. *다음* 단추를 클릭합니다. 그러면 앱 스토어에 대한 응용 프로그램의 유효성이 검사됩니다.
    ...
    [![](app-store-publishing-images/publishvs03.png "앱 스토어에 대해 유효성을 검사 하는 응용 프로그램")](app-store-publishing-images/publishvs03.png#lightbox)
...
[![](app-store-publishing-images/image21.png "검토 대기를 표시 하는 iTunes Connect의 상태")](app-store-publishing-images/image21.png#lightbox)
