...
무료 프로비전을 사용하여 장치에 Xamarin.iOS 애플리케이션을 배포하려면:
...
13. Xcode를 테스트하려면 [실행] 단추를 클릭하여 장치에 새 애플리케이션을 배포합니다.
...
Apple은 개발자가 *자신의* 장치에만 배포할 수 있도록 보장하기 위해 무료 프로비전을 사용하여 iOS 장치에서 애플리케이션을 실행할 수 있는 시기 및 방법에 대한 여러 제한을 두었습니다.
...
이 가이드에서는 무료 프로비전을 사용하여 iOS 장치에 애플리케이션을 설치하는 방법의 장점과 제한 사항에 대해 알아보았습니다. 무료 프로비전을 사용하여 Xamarin.iOS 앱을 설치하는 방법을 설명하는 단계별 연습을 제공했습니다.
