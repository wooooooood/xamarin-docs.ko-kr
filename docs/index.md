...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3 class="x-hidden-focus">설정 및 설치</h3>
                                    <p>Visual Studio Tools for Xamarin을 설치하는 방법을 알아봅니다.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3 class="x-hidden-focus">샘플</h3>
                                    <p>기능 샘플 및 이미 빌드된 앱입니다.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3 class="x-hidden-focus">새로운 기능</h3>
                                    <p>Xamarin Docs의 새로운 기능을 참조하세요.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <h1 class="screenReader">Xamarin 설명서</h1>
        <ul class="pivots">
            <li>
                <li>
                            ...
                            <li>
                               <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Xamarin에 대해 알아보기</h3>
                                                <h4>Windows 및 macOS의 Visual Studio에서 C# 및 .NET을 사용하여 Xamarin.Forms에서 플랫폼 간 Android 및 iOS 앱을 빌드합니다.</h4>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="~/cross-platform/get-started/introduction-to-mobile-development.md"><img  src="https://docs.microsoft.com/media/logos/logo_xamarin.svg" alt="" />Xamarin이란?</a></li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>빠른 시작</h3>
                                                <h4>다음 가이드에 따라 Xamarin.Forms에서 첫 번째 플랫폼 간 Android 및 iOS 앱을 빌드하세요(한 번에 5분 소요).</h4>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>자습서</h3>
                                                <h4>Xamarin.Forms에서 플랫폼 간 Android 및 iOS 앱 개념에 대해 알아봅니다.</h4>
                                                <table cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td style="border-top-color:transparent!important;padding-left:0;">
                                                            <ul class="noBullet">
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>기존 지식 활용</h3>
                                                <h4>Xamarin 프로젝트를 사용하면 현재 기술을 적용하여 Android 및 iOS 앱을 빌드할 수 있습니다. 자세한 내용은 원하는 플랫폼을 선택하세요.</h4>
                        ...
                        <ul id="XamarinForms" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p>
Xamarin.Forms는 C# 및 .NET을 사용하는 Android, iOS, Mac 및 Windows용 플랫폼 간 도구 키트입니다. 모든 플랫폼에서 사용자 인터페이스 코드와 앱 논리 코드를 공유합니다.
                                    </p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Xamarin.Forms이란?</h3>
                                                    <p>Xamarin.Forms의 정의와 Android 및 iOS 앱을 빌드하고 배포하는 방법에 대해 설명합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>애플리케이션 기본 사항</h3>
                                                    <p>탐색, 제스처, 데이터 바인딩을 비롯해 Xamarin.Forms 앱을 개발하는 데 필요한 모든 것을 알아봅니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SkiaSharp 그래픽 전자책</h3>
                                                    <p>SkiaSharp를 사용한 플랫폼 간 벡터 그래픽 및 애니메이션입니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows용 iOS 시뮬레이터</h3>
                                                    <p>Windows에서 Visual Studio를 사용하여 iOS 시뮬레이터와 상호 작용합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>.NET 포함</h3>
                                                    <p>다른 프로그래밍 언어에서 기존 .NET 코드를 사용하도록 허용합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>MonoGame</h3>
                                                    <p>C#을 사용하여 데스크톱, 모바일 및 콘솔 게임을 빌드합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="container centered pageFooter">
        ...
        <ul class="links">
           <li>
                <a href="https://devblogs.microsoft.com/xamarin/"> 블로그 </a>
            </li>
            <li>
