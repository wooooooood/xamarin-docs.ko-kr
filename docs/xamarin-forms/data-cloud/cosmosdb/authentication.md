---
title: Azure Cosmos DB 문서 데이터베이스를 사용 하 여 사용자 인증
...
ms.locfileid: "53055675"
---
# <a name="authenticating-users-with-an-azure-cosmos-db-document-database"></a>Azure Cosmos DB 문서 데이터베이스를 사용 하 여 사용자 인증
...
1. Azure portal에서 웹 앱에 대 한 앱 설정 블레이드에서 열고 다음 설정을 추가 합니다.
    ...
    [![](authentication-images/azure-web-app-settings.png "App Service 웹 앱 설정을")](authentication-images/azure-web-app-settings-large.png#lightbox "App Service 웹 앱 설정")
...
1. Azure Portal을 열고 인증 / 권한 부여 블레이드 다음 구성을 수행 합니다.
  ...
  [![](authentication-images/app-service-authentication-settings.png "App Service 웹 앱 인증 설정")](authentication-images/app-service-authentication-settings-large.png#lightbox "App Service 웹 앱 인증 설정")
...
문서 컬렉션에서 문서를 검색 하는 방법에 대 한 자세한 내용은 참조 하세요. [검색 문서 컬렉션 문서](~/xamarin-forms/data-cloud/cosmosdb/consuming.md#document_query)합니다.
...
문서 컬렉션에 문서를 삽입 하는 방법에 대 한 자세한 내용은 참조 하세요. [문서 컬렉션에 문서를 삽입](~/xamarin-forms/data-cloud/cosmosdb/consuming.md#inserting_document)합니다.
...
문서 컬렉션에서 문서를 삭제 하는 방법에 대 한 자세한 내용은 참조 하세요. [문서 컬렉션에서 문서를 삭제 하면](~/xamarin-forms/data-cloud/cosmosdb/consuming.md#deleting_document)합니다.
