---
제목: ' 설명: '의 종속성 확인 Xamarin.Forms :이 문서는 Xamarin.Forms 응용 프로그램의 종속성 주입 컨테이너가 사용자 지정 렌더러, 효과 및 DependencyService 구현의 생성 및 수명을 제어 하도록 종속성 확인 방법을에 삽입 하는 방법을 설명 합니다.
...
# <a name="dependency-resolution-in-xamarinforms"></a>종속성 확인Xamarin.Forms
