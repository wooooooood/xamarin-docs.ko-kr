...
> [!NOTE]
> **참고**: 각 플랫폼 프로젝트에서 효과 제공 하는 선택 사항입니다. 하나이 등록 되지 않은 경우 효과 사용 하려고 하면 아무 작업도 수행 하는 null이 아닌 값을 반환 됩니다.
...
> [!NOTE]
> **참고**: 효과 인스턴스는 단일 제어만 연결할 수 있습니다. 따라서 두 컨트롤에서 사용 하려면 두 번 효과 해결 해야 합니다.
