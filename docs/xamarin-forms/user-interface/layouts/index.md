---
title: Xamarin.Forms에는 레이아웃
description: Xamarin.Forms 화면의 콘텐츠를 구성 하기 위한 몇 가지 기능과 레이아웃 않았으며이 문서에 설명 됩니다.
ms.prod: xamarin
...
ms.locfileid: "35244892"
---
# <a name="layouts-in-xamarinforms"></a>Xamarin.Forms에는 레이아웃
