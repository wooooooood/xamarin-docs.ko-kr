...
CocosSharp 游戏引擎提供了大量功能和深度，因此，本指南仅讲述了 CocosSharp 可以执行的操作。 CocosSharp에 대해 자세히 알고 싶은 개발자는 [cocossharp archive](https://github.com/xamarin/docs-archive/blob/master/Docs/CocosSharp/)에서 많은 문서를 찾을 수 있습니다.
