...
ms.locfileid: "59509904"
---
# <a name="xamarinforms-views"></a>Xamarin.Forms 뷰

[![D샘플 다운로드](~/media/shared/download.png) 샘플 다운로드](https://developer.xamarin.com/samples/FormsGallery/)
