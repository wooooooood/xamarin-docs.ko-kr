---
제목: "iOS의 모달 페이지 프레젠테이션 스타일" 설명: "플랫폼별를 사용 하면 사용자 지정 렌더러 나 효과를 구현 하지 않고 특정 플랫폼 에서만 사용할 수 있는 기능을 사용할 수 있습니다. 이 문서에서는 모달 페이지의 프레젠테이션 스타일을 설정 하는 iOS 플랫폼별를 사용 하는 방법을 설명 합니다. "
assetid: C791F7CF-330A-44BA-987A-4CFCCBB9278B: xamarin-forms author: davidbritch: dabritch:: 04/02/2020-loc: [ Xamarin.Forms ,]입니다. Xamarin.Essentials
---
