---
제목: 설명: ' 플랫폼 특성을 사용 하면 사용자 지정 렌더러 또는 효과를 구현 하지 않고 특정 플랫폼 에서만 사용할 수 있는 기능을 사용할 수 있습니다. 이 문서에서는 레거시 색 모드를 사용 하지 않도록 설정 하는 Android 플랫폼별를 사용 하는 방법을 설명 Xamarin.Forms 합니다.
