...
#### [암시적 스타일](user-interface/styles/implicit.md)
#### [글로벌 스타일](user-interface/styles/application.md)
#### [스타일 상속](user-interface/styles/inheritance.md)
#### [동적 스타일](user-interface/styles/dynamic.md)
#### [장치 스타일](user-interface/styles/device.md)
...
##### [Windows 10 유니버설](platform/windows/installation/universal.md)
