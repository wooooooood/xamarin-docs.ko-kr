...
### [단일 페이지 빠른 시작](~/get-started/quickstarts/single-page.md)
### [다중 페이지 빠른 시작](~/get-started/quickstarts/multi-page.md)
### [로컬 데이터베이스 빠른 시작](~/get-started/quickstarts/database.md)
...
### 도구
#### [XAML 핫 다시 로드](xaml/hot-reload.md)
#### [XAML 도구 상자](xaml/toolbox.md)
#### [XAML 미리 보기](xaml/xaml-previewer/index.md)
##### [디자인 타임 데이터](xaml/xaml-previewer/design-time-data.md)
##### [사용자 지정 컨트롤](xaml/xaml-previewer/render-custom-controls.md)
### 네임스페이스
#### [XAML 네임스페이스](xaml/namespaces.md)
#### [XAML 사용자 지정 네임스페이스 스키마](xaml/custom-namespace-schemas.md)
#### [XAML Namespace 권장 접두사](xaml/custom-prefix.md)
### 추가 기능
...
#### [상대 바인딩](app-fundamentals/data-binding/relative-bindings.md)
...
#### [재사용 가능한 RoundEffect](app-fundamentals/effects/reusable-roundeffect.md)
...
#### [이를 통해 검색](app-fundamentals/shell/search.md)
...
### [단추](user-interface/button.md)
### [CarouselView](user-interface/carouselview/index.md)
#### [소개](user-interface/carouselview/introduction.md)
#### [데이터](user-interface/carouselview/populate-data.md)
#### [레이아웃](user-interface/carouselview/layout.md)
#### [상호 작용](user-interface/carouselview/interaction.md)
#### [EmptyView](user-interface/carouselview/emptyview.md)
#### [스크롤](user-interface/carouselview/scrolling.md)
...
#### [데이터](user-interface/collectionview/populate-data.md)
#### [레이아웃](user-interface/collectionview/layout.md)
#### [선택 항목](user-interface/collectionview/selection.md)
#### [EmptyView](user-interface/collectionview/emptyview.md)
#### [스크롤](user-interface/collectionview/scrolling.md)
#### [그룹화](user-interface/collectionview/grouping.md)
...
### [팝업 표시](user-interface/pop-ups.md)
...
### 레이아웃
#### [개요](user-interface/layouts/index.yml)
#### [레이아웃 선택](user-interface/layouts/choose-layout.md)
...
#### [데이터 원본](user-interface/listview/data-and-databinding.md)
...
### Map
#### [초기화 및 구성](user-interface/map/index.md)
#### [핀](user-interface/map/pins.md)
#### [다각형 및 폴리라인](user-interface/map/polygons.md)
#### [지오코딩](user-interface/map/geocoder.md)
...
##### [디바이스 스타일](user-interface/styles/xaml/device.md)
##### [스타일 클래스](user-interface/styles/xaml/style-class.md)
...
### [테마](user-interface/theming.md)
### [TimePicker](user-interface/timepicker.md)
### [ToolbarItem](user-interface/toolbaritem.md)
### [Visual](user-interface/visual/index.md)
#### [재질 Visual](user-interface/visual/material-visual.md)
#### [Visual 렌더러 만들기](user-interface/visual/create.md)
### [시각적 상태 관리자](user-interface/visual-state-manager.md)
### [WebView](user-interface/webview.md)
## 플랫폼 기능
### [개요](platform/index.yml)
### Android
#### [개요](platform/android/index.md)
#### [AppCompat 및 재질 디자인](platform/android/appcompat-material-design.md)
#### [단추 안쪽 여백 및 섀도](platform/android/button-padding-shadow.md)
#### [항목 입력 방법 편집기 옵션](platform/android/entry-ime-options.md)
#### [ImageButton 그림자](platform/android/imagebutton-drop-shadow.md)
#### [ListView 빠른 스크롤](platform/android/listview-fast-scrolling.md)
#### [NavigationPage 막대 높이](platform/android/navigationpage-bar-height.md)
#### [페이지 수명 주기 이벤트](platform/android/page-lifecycle-events.md)
#### [소프트 키보드 입력 모드](platform/android/soft-keyboard-input-mode.md)
#### [TabbedPage 페이지 살짝 밀기](platform/android/tabbedpage-page-swiping.md)
#### [TabbedPage 페이지 전환 애니메이션](platform/android/tabbedpage-transition-animations.md)
#### [TabbedPage 도구 모음 배치 및 색](platform/android/tabbedpage-toolbar-placement-color.md)
#### [ViewCell 컨텍스트 작업](platform/android/viewcell-context-actions.md)
...
#### [서식 지정](platform/ios/formatting.md)
...
#### [VisualElement 레거시 색 모드](platform/ios/legacy-color-mode.md)
### Windows
#### [개요](platform/windows/index.md)
...
#### [RefreshView 풀 방향](platform/windows/refreshview-pulldirection.md)
...
### [Apple에서 로그인](platform/sign-in-with-apple/index.md)
#### [iOS용 설정](~/ios/platform/ios13/sign-in.md)
#### [기타 플랫폼용 설정](platform/sign-in-with-apple/setup.md)
#### [Apple에서 로그인 사용](platform/sign-in-with-apple/android-ios-sign-in.md)
...
#### [REST (영문)](data-cloud/web-services/rest.md)
### 인증
#### [인증 개요](data-cloud/authentication/index.md)
#### [REST (영문)](data-cloud/authentication/rest.md)
