...
| <h3>지도</h3>지도를 표시 합니다.<p align="center">![지도의 스크린샷](xaml-controls-images/Map.png "맵")</p>[API](xref:Xamarin.Forms.Maps.Map)  /  [가이드](~/xamarin-forms/user-interface/map/index.md) | <p valign="center"><pre>&lt;maps:Map ItemsSource="{Binding Locations}" /&gt;</pre></p> |
