...
[ ![](standard-controls-images/intro01.png "예제 응용 프로그램의 주 화면")](standard-controls-images/intro01.png)
...
[ ![](standard-controls-images/mailapp.png "Mac 창 프레임")](standard-controls-images/mailapp.png)
...
[ ![](standard-controls-images/edit01.png "솔루션 탐색기에서 주 스토리 보드를 선택합니다.")](standard-controls-images/edit01.png)

Xcode의 인터페이스 작성기의 창 디자인을 열립니다.

[ ![](standard-controls-images/edit02.png "Xcode에서 스토리 보드를 편집합니다.")](standard-controls-images/edit02.png)
...
[ ![](standard-controls-images/edit03.png "라이브러리에서 분할 뷰를 선택합니다.")](standard-controls-images/edit03.png)
...
[ ![](standard-controls-images/edit04.png "제약 조건 설정")](standard-controls-images/edit04.png)

사용 하 여는 **빨간색 I-빔** 바깥쪽 둘레는 **Autoresizing** 상자 _스틱_ (x, y) 지정된 된 위치를 제어 합니다. 예: 

[ ![](standard-controls-images/edit05.png "제약 조건 편집")](standard-controls-images/edit05.png)

지정 하는 선택한 컨트롤 (에 **계층 보기** & **인터페이스 편집기**)를 조정 하거나 이동할 때 창 또는 보기의 위쪽 및 오른쪽 위치를 멈출 수입니다. 

편집기의 다른 요소 높이 및 너비와 같은 속성을 제어 합니다.

[ ![](standard-controls-images/edit06.png "높이 설정합니다.")](standard-controls-images/edit06.png)

사용 하 여 제약 조건이 있는 요소의 맞춤을 제어할 수도 있습니다는 **맞춤 편집기**:

[ ![](standard-controls-images/edit07.png "맞춤 편집기")](standard-controls-images/edit07.png)
...
[ ![](standard-controls-images/edit10.png "Xcode에 사용자 지정 클래스를 설정합니다.")](standard-controls-images/edit10.png)
...
[ ![](standard-controls-images/edit11.png "편집 하는 올바른 파일 선택")](standard-controls-images/edit11.png)

지정으로 AppKit 컨트롤에서 컨트롤 끌기 `.h` 파일 만들기를 시작 하는 **콘센트** 또는 **동작**:

[ ![](standard-controls-images/edit12.png "드래그 하 여 콘센트 또는 동작 만들기")](standard-controls-images/edit12.png)

만들고에 대 한 노출의 유형을 선택 된 **콘센트** 또는 **동작** 는 **이름**: 

[ ![](standard-controls-images/edit13.png "콘센트 또는 동작 구성")](standard-controls-images/edit13.png)
...
[ ![](standard-controls-images/sync01.png "Xcode 사용 하 여 동기화 중 변경")](standard-controls-images/sync01.png)
...
[ ![](standard-controls-images/buttons01.png "여러 가지 단추 종류의 예")](standard-controls-images/buttons01.png)
...
[ ![](standard-controls-images/buttons03.png "키에 해당 하는 편집")](standard-controls-images/buttons03.png)
...
[ ![](standard-controls-images/buttons02.png "사용 가능한 확인란을 선택 합니다. 형식 예")](standard-controls-images/buttons02.png)
...
[ ![](standard-controls-images/menu01.png "메뉴 컨트롤 예제")](standard-controls-images/menu01.png)
...
[ ![](standard-controls-images/menu02.png "예제에서는 menu 컨트롤")](standard-controls-images/menu02.png)
...
[ ![](standard-controls-images/select01.png "선택 컨트롤 예")](standard-controls-images/select01.png)
...
[ ![](standard-controls-images/level01.png "예제 표시기 컨트롤")](standard-controls-images/level01.png)
...
[ ![](standard-controls-images/text01.png "텍스트 컨트롤 예제")](standard-controls-images/text01.png)
...
[ ![](standard-controls-images/content01.png "예제 콘텐츠 뷰")](standard-controls-images/content01.png)
...
2. 끌어서는 **컨트롤러 볼** 에서 **라이브러리 검사기** 에 **인터페이스 편집기**: 
    ...
    [ ![](standard-controls-images/content02.png "라이브러리에서 보기 컨트롤러를 선택 하면")](standard-controls-images/content02.png)
4. 크기 및 레이아웃을 정의 합니다.는 **사용자 지정 보기**: 

    [ ![](standard-controls-images/content04.png "레이아웃 편집")](standard-controls-images/content04.png)
5. 컨트롤을 클릭 하 고에 팝업의 소스에서 끌어는 **뷰-컨트롤러**: 

    [ ![](standard-controls-images/content05.png "드래그 하 여 한 segue 만들기")](standard-controls-images/content05.png)
6. 선택 **Popover** 팝업 메뉴에서: 

    [ ![](standard-controls-images/content06.png "설정 segue 유형")](standard-controls-images/content06.png)
...
[ ![](standard-controls-images/content08.png "탭의 개수를 편집합니다.")](standard-controls-images/content08.png)

각 탭에 선택은 **인터페이스 계층 구조** 설정 하려면 해당 **제목** UI 요소를 추가 하 고 해당 **창**:

[ ![](standard-controls-images/content09.png "Xcode에서 탭을 편집합니다.")](standard-controls-images/content09.png)
